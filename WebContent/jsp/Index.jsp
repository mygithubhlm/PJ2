...
function assortment() {
		...
		var num="hlm";"<%--=(String)session0.getAttribute("account")--%>";
		//alert("ss");
	...
	<div id="wrapper">
		...
		<ul id="mainMeau">
			...
			<li class="border"><a href="Blog.jsp"+<%=handle.getName(account)%>>博文显示</a></li>
        ...
        <!--第一篇文章-->
             ...
             <div id="Blog_2" class="bottom" >
                ...
                <div class="tip0">
                 ...
                 <p class="content02"> <%=HandleText.getSubString(HandleText.getText(handle.getName("hlm"))[1])%></p><%-- “鳕鱼，是海洋深水鱼，肉质厚实，刺极少，味道甘美。鳕鱼肉中的蛋白质含量比一般的鱼都高，所含脂肪却很少，是特别营养的美食。除了富含普通鱼油中的DHA、DPA，还含有人体所需的维生素A、D、E和其他各种维生素，有餐桌上的“营养师”之称！
