...
<div id="wrapper">
    ...
    <div id="center">
        <p>正文</p>
             <div id="Blog_3" class="bottom">
                ...
                <ul id="read" >
                     <li class="border">阅读</li>
                     <li class="border" id="praise" onclick=praise()>&nbsp;赞(<%=dataBase.SomeMethod.getPraisesNum(HandleText.getAllTitle()[number]) %>)&nbsp;</li>
    ...
    <div id="left_down">
             ...
             <ul id="mainMenu">
                <li><a class="light" href="Blog02.jsp?number=0">全部博文</a>(4)</li>
                <li><a href="Blog02.jsp?number=2">科技新闻</a>(2)</li>
                <li><a href="Blog02.jsp?number=0">休闲时刻</a>(1)</li>
                <li><a href="Blog02.jsp?number=1">吃货必看</a>(1)</li>
             </ul>
    </div>
